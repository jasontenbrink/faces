...
/***/ function(module, exports) {
	...
	function DirectoryController($scope, DataService, uiGridConstants, $timeout, $mdDialog, MemberService, AddressService) {
	  var dataService = DataService;
	  ...
	  $scope.isActive = [true, true, true, false, false, false, true, false, false, true, true, true, false, false];
...
/***/ function(module, exports) {
	...
	function NavController($scope, $http, $location) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ErrorBanner = function (_Component) {
	    _inherits(ErrorBanner, _Component);
	...
	angular.module('app').directive('error', ['reactDirective', function (reactDirective) {
